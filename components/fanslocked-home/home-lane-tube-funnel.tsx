  ...
  return (
    ...
    >
      <div className="rounded-2xl border border-[rgba(255,122,0,0.18)] bg-[rgba(255,122,0,0.06)] px-5 py-6 md:px-8 md:py-7">
        ...
        >
          Popular upgrades from free tubes
        </h2>
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-[#A0A6B1]">
          Tubes are great for volume. When you want interaction, creators, or
          cleaner premium libraries, switch lanes below — same homepage, no
          extra clicks to get started.
        </p>
            ...
            <li key={item.title}>
              {item.intent ? (
                <button
                  ...
                  className={cn(
                    "flex h-full w-full flex-col rounded-xl border px-4 py-3.5 text-left transition-colors duration-150",
                    "focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary",
                    item.emphasis
                      ? "border-[#FF7A00]/35 bg-[#0A0B10]/80 hover:border-[#FF7A00]/55 hover:bg-[#0A0B10]"
                      : "border-white/10 bg-[#0A0B10]/60 hover:border-white/18",
                  )}
                >
                ...
                <Link
                  href={item.href!}
                  className={cn(
                    "flex h-full flex-col rounded-xl border border-white/10 bg-[#0A0B10]/60 px-4 py-3.5 text-left transition-colors duration-150",
                    "hover:border-[#FF7A00]/35 hover:bg-[#0A0B10]/80",
                    "focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary",
                  )}
                >
                  <span className="text-sm font-semibold text-white">

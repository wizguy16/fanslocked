...
export function generateMetadata({ params }: Props): Metadata {
  ...
  if (params.slug === "hookup") {
    return {
      title: `${h1} (${year})`,
      description:
        "Find the best hookup and dating sites in 2026—casual dating apps, discreet platforms, and location-based matching. Compare top hookup apps and adult dating sites ranked for activity, privacy, and ease of use.",
      keywords: [
        "best hookup sites",
        "hookup apps",
        "casual dating sites",
